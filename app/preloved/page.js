    ...
    <div className="min-h-screen px-6 py-12 flex justify-center">
      ...
      <div className="w-full max-w-4xl bg-neutral-whiteOverlay rounded-2xl shadow-soft p-10">
        ...
        <header className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-hellobumble text-neutral-blackText mb-4">
            HelloBumble Pre-Loved
          </h1>
          <p className="text-lg md:text-xl font-description italic text-neutral-blackText">
            Where quality lives on, and every nappy gets the chance to tell a second story.
          </p>
        </header>

        {/* Intro Section */}
        <section className="text-center font-description text-neutral-blackText space-y-4 mb-12">
          <p>
        ...
        {/* How It Works */}
        <section className="space-y-10 font-description text-neutral-blackText">

          <div className="space-y-3">
            <h3 className="text-xl font-semibold">1. Send Your Nappies Home</h3>
            <p>
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">2. We Gently Grade & Refresh Them</h3>
            ...
            <p>
              We prepare each one with care, making sure it’s fresh, safe, and ready to be loved again.
            </p>
          </div>

          <div className="space-y-3">
            <h3 className="text-xl font-semibold">3. You Receive Store Credit</h3>
            <p>As a thank-you for giving your nappies a second life, you’ll receive:</p>
            <ul className="list-disc list-inside ml-6">
              <li>Rx credit for NB/Small</li>
              <li>Rx credit for Medium/Large/XL</li>
              <li>Rx credit for boosters</li>
            </ul>
            <p>
              (You simply cover the return shipping.){" "}
              <Link href="/preloved/tandc" className="underline text-neutral-palePurpleClickable">
                T&Cs apply
              </Link>
              .
            </p>
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">4. Another Baby Gets a Beautiful Start</h3>
            <p>
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-semibold">5. The Circle Continues</h3>
            <p>
        ...
        <section className="mt-12 text-center">
          <Link href="/preloved/store" className="btn-primary">
