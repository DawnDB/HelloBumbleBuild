...
export default function ProductsAndMaterials() {
  return (
    <div className="min-h-screen flex flex-col items-center bg-[url('/pastel-marble.jpg')] bg-cover bg-center px-6 py-20">

      {/* Main Content Box */}
      <div className="w-full max-w-3xl bg-whiteOverlay rounded-2xl shadow-soft p-10 text-center">

        {/* Page Title */}
        <h1 className="text-5xl mb-10 font-hellobumble">
          Products & Materials
        </h1>

        {/* PRODUCTS SECTION */}
        <h2 className="text-2xl mb-4 font-description tracking-wider">
          Products
        </h2>

        <p className="mb-8 font-description leading-relaxed">
        ...
        <p className="mb-12 font-description leading-relaxed">
        ...
        {/* MATERIAL LIST */}
        <ul className="text-left mx-auto mb-10 font-description leading-relaxed list-disc pl-6">
          <li>Cotton</li>
          <li>Hemp</li>
          <li>Bamboo</li>
          <li>Polyester</li>
        ...
        {/* Closing Line */}
        <p className="font-description tracking-wider text-lg opacity-95">
